...
@section('content')
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="/utiliti/syarikat/senarai">
                        @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">                                
                                        <div class="form-group">
                                            ...
                                            {{ Form::text('sya_desc', session('sya_desc'),['class'=>'form-control']) }}
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="margin" style="float:right;">
                                            <div class="btn-group">
                                                <a href="/utiliti/syarikat/senarai" class="btn bg-purple">Reset</a>
                                            </div>
                                            <div class="btn-group">
                            ...
                            <div id="ptj_table">
                                <table id="example1" class="table table-bordered table-striped">
                                    <thead>
                                        ...
                                        <th width="10%">No Syarikat</th>
                                        <th width="40%">Nama Syarikat</th>
                                        <th width="25%">Daerah</th>
                ...
                <form class="form-horizontal" action="" method="post" id="insert_form">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label for="user_nama" class="form-label">No Syarikat</label>
                                    {{ Form::text('ptj_code',null,['class'=>'form-control', 'id'=>'ptj_code']) }}
                                </div>                                                           
                            </div>                            
                            <div class="col-sm-8">
                                <div class="form-group">
                                    <label for="sya_desc" class="form-label">Nama Syarikat</label>
                                    {{ Form::text('sya_desc',null,['class'=>'form-control', 'id'=>'sya_desc']) }}
                                </div>
                            </div>
                        </div>
                        <div class="row">
